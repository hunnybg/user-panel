...
exports.check_zone = function (city_id, type_id, vehicle_id, zone_business, store_location, destination_location, return_data) {
            ...
            if (cityzone.length == 0) {
                ...
                cityzone.forEach(function (zone_data) {
                    ...
                    if (destination_zone_id && store_zone_id && !bool) {
                        ...
                        bool = true;
                        ZoneValue.findOne({$or: [{from_zone_id: store_zone_id, to_zone_id: destination_zone_id}, {from_zone_id: destination_zone_id, to_zone_id: store_zone_id}], type_id: type_id, vehicle_id: vehicle_id, delivery_type_id: mongoose.Types.ObjectId('586f7db95847c8704f537bd1')}, function (err, zonevalue) {
