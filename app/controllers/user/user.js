                                                    ...
                                                    if(!request_data_body.is_courier){
                                                        ...
                                                        Delivery.find({
                                                            ...
                                                            if (delivery.length == 0) {
                                                                ...
                                                                var condition = { $match: {$and: [{country_id: {$eq: country_id}}, {ads_for: {$eq: ADS_TYPE.FOR_DELIVERY_LIST}},
                                        ...
                                        City.findOne({_id: city_id}).then((city_detail) => {
                                            if (city_detail) {
                                                ...
                                                Service.find(query).then((service_list) => {
                                                    ...
                                                    if (service) {
                                                        utils.check_zone(city_id, delivery_price_used_type_id, service.vehicle_id, city_detail.zone_business, store_location, destination_location, function (zone_response) {
                                                            /* HERE USER PARAM */
                                            ...
                                            City.findOne({_id: city_id}).then((city_detail) => {
                                                if (city_detail) {
                                                    ...
                                                    Service.find(query).then((service_list) => {
                                                        ...
                                                        if (service) {
                                                            utils.check_zone(city_id, delivery_price_used_type_id, service.vehicle_id, city_detail.zone_business, pickup_location, destination_location, function (zone_response) {
                                                                /* HERE USER PARAM */
                                    ...
                                    Store.findOne({_id: order_payment.store_id}).then((store) => {
                                        // if(store && store.is_active && store.is_business){
                                            ...
                                            if(store){
                                                ...
                                                query = {delivery_type: request_data_body.delivery_type_id}
                                            }
