...
exports.cancellation_reason_list = function (request_data, response_data) {
    utils.check_request_params(request_data.body, [], function (response) {
        if (response.success) {
            ...
            Order.aggregate([order_condition, user_query, order_payment_query, store_query, array_to_json_user_detail, array_to_json_store_detail, country_query, array_to_json_country_query, array_to_json_order_payment_query
                        , search
                        , filter
                        , count
            ]).then((orders) => {
